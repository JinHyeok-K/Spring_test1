...
board_list(1,0, "","" ); // cno,page, key,keword,
category_list( );
////////////////////////////////////////////////////////////////////////////////////////////////


////////////////////////// 전역변수 : 페이지 변화 시에도 변수를 계속 사용하기 위해서 사용 ////////////////////////////////////////////////
...
function board_list(cno,page, key , keyword  ){
      ...
      //  if(  this.current_page == "undefined" ) { this.current_cno = 0};
...
//        this.current_keyword = keyword;
        ...
        alert("현재 카테고리 :" + this.current_cno );
       alert("현재 페이지 :" + this.current_page );
...
///////////////////////////////  # 페이징 버튼 생성 code //////////////////////////////////////
                let pagehtml ="";
                 ...
                 pagehtml +=
                 '<li class="page-item">'+
                        '<button class="page-link" onclick="board_list('+cno+','+(page-1)+')"> 이전 </button>'+
                 '</li>';
                 }
                  ////////////////
                 //// 가운데 페이징 ////
               ...
               if(page== boardlist.totalpages-1){ // 현재 페이지가 마지막 페이지이면
                   pagehtml +=
                     '<li class="page-item">'+
                       //     '<button class="page-link" onclick="board_list('+cno+','+(page)+')"> 다음 </button>'+
                            '<button class="page-link" onclick="board_list('+cno+','+ (page)  +')"> 다음 </button>'+  // 검색 없음
                     '</li>';
               }else{ // 현재 페이지가 마지막 페이지가 아니면
                  pagehtml +=
                  '<li class="page-item">'+
                         '<button class="page-link" onclick="board_list('+cno+','+(page+1)+')"> 다음 </button>'+
                  '</li>';
                  }
               ///////////////////////////////////////////////// 페이징 버튼 끝//////////////////////////////////////
                ...
                $("#pagebtnbox").html(pagehtml); // 페이징 버튼 html 넣기
                 ////////////////////////////////////////////////////////////////////////
            }
        });
...
function categorybtn(  cno  ){
    ...
    board_list( cno, 0 , "" , "" ); // 검색이 없을경우 공백 전달 =>  카테고리 버튼을 눌렀을 때 초기화
